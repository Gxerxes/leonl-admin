import {NgModule, Component, Input, AfterContentInit, OnDestroy, OnInit, ContentChildren, QueryList} from "@angular/core";
...
class Tabset implements AfterContentInit {
  ...
  setActive(tab: Tab) {
    this.tabs.toArray().forEach((t: any) => t.avtive = false);
    tab.active = true;
  }
}
